...
export const TextRevealCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="h-[100px]  relative flex items-center overflow-hidden">
        <motion.div
          style={{
            width: "100%",
          }}
        ...
        <motion.div
          ...
          transition={isMouseOver ? { duration: 0 } : { duration: 0.4 }}
          className="h-[60px] w-[8px] bg-gradient-to-b from-transparent via-neutral-800 to-transparent absolute z-50 will-change-transform"
        ></motion.div>
